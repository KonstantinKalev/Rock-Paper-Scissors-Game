...
function rockClick(){
    ...
    rockBtn.style.transform = "translateY(-130px)";
    ...
    if (robotChoice === 1){
        ...
        robotRock.style.transform = "translateY(55px)";
        ...
        if (yourPoints == 10){
            ...
            setTimeout(function() {
                ...
                messageTxt.style.fontSize = "3rem";
            }, 800);
        }
    } 
        ...
        robotPaper.style.transform = "translateY(55px)";
        ...
        robotScissors.style.transform = "translateY(55px)";
...
function paperClick(){
    ...
    scissorsBtn.style.display = "none";
    paperBtn.style.transform = "translateY(-130px)";
...
function scissorsClick(){
    rockBtn.style.display = "none";
    paperBtn.style.display = "none";
    scissorsBtn.style.transform = "translateY(-130px)";
